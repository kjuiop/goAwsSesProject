...
func main() {
	...
	sender := flag.String("From", "arneg0shua@gmail.com", "The email address for the 'From' field")
	recipient := flag.String("To", "arneg0shua@gmail.com", "The email address for the 'To' field")
	subject := flag.String("Subject", "Amazon SES Test (AWS SDK for Go)", "The text for the 'Subject' field")
	flag.Parse()
